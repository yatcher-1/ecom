    ...
    <div className="section-title text-center mb-55"><h2>Product Cart List</h2>   
     ...
     <Col className="p-1" lg={12} md={12} sm={12} xs={12} >
          <Card >                
               ...
               <Row>
                    <Col md={3} lg={3} sm={6} xs={6}>
                         <img className="cart-product-img" src="https://rukminim1.flixcart.com/image/416/416/knm2s280/mobile/j/x/c/hot-10-play-x688b-infinix-original-imag29gxqzuxkmnk.jpeg?q=70" alt=""/>
                    </Col>
